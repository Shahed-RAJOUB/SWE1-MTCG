...
{
    public abstract class SuperSpellCard : ICard
    {
        protected SuperSpellCard(string cardName , string cardType , int cardId , int cardDamage , bool activity , Element[] effect)
        {
